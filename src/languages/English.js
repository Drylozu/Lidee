    ...
    constructor() {
        super({
            strings: {
                ...
                // Logs
                logsNoOption: "You must place one of the valid options: (`messages`).",
                logsNoValid: "You must place a valid channel.",
                logsNoPermissions: "I can't send send messages on the chosen channel, be sure to check my permissions.",
                logsSave: "Saved configuration"
            }, constants: {
                permissions: {
                ...
                logsDescription: "Configure a channel for the server logs.",
                // Commands Usage
